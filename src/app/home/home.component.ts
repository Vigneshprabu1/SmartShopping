    ...
    //  var i=0;
      {
        ...
        this.combine1.price =this.listData[i].price;
         this.combine1.quantity=this.listData[i].quantity;
...
add(pid:Product){
   ...
   for(var i=0;i<this.listData.length;i++){
    ...
    {  
      ...
      this.listData[i].quantity -= 1;
       this.combine[i].quantity=this.listData[i].quantity;
      }
    }           
  }
  ...
  //       // console.log(this.listData[i].quantity)
       jj[i].quantity=jj[i].quantity-this.listData[i].quantity;
       }
       else{
         jj[i].quantity=0;
       }
 ...
 this.data.getp(this.product);
  ...
  alert("Your selected:"+this.listData[this.j].quantity+"itemsAnd Total Price is:$"+this.listData[this.j].total);
